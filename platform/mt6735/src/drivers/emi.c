...
*/
        ...
        *((V_UINT32P)(DRAMC0_BASE + 0x00d8)) = 0x00500900;    // [31:30] pinmux no use for Denali, only PINMUX2 (0xf0[30])
...
int DFS_ability_detection(void)
{
    ...
    if (DDR_TYPE == TYPE_LPDDR3) {
	    ...
	    if ((rank0_coarse <=20 && rank0_fine >= 56) && ((*((volatile unsigned int *)(0x10206048)) & 0x00000200) == 0)) {
#else // Denali-1/2
	    if ((rank0_coarse <=20 && rank0_fine >= 56)) {
#endif
...
#if defined(MACH_TYPE_MT6753)
	    if ((rank0_coarse <=20 && rank1_coarse <=20 && rank0_fine >= 56 && rank1_fine >= 56) && ((*((volatile unsigned int *)(0x10206048)) & 0x00000200) == 0)) {
#else // Denali-1/2
...
#if defined(MACH_TYPE_MT6753)
	printf("Denali-3 LPDDR2 DFS always disable\n");
	*((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) & ~(0x1 << 15);
	*((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) & ~(0x1 << 15);
#else
	printf("Denali-1 LPDDR2 DFS always enable\n");
	*((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) | (0x1 << 15);
	*((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) | (0x1 << 15);
#endif
    } else {
...
// Run time config
    ...
    *((V_UINT32P)(DDRPHY_BASE + 0x01ec)) |= (0x4f10);
    ...
    // For Denali1/2/3 and Rainier, please set dramc AO 0xfc[26:25]=2'b00 (the same as ROME/K2)
...
#endif
#else
    printf("Denali-2/3 LPDDR2/3 DFS always enable\n");
    *((V_UINT32P)(DRAMC0_BASE + 0xf4)) = *((V_UINT32P)(DRAMC0_BASE + 0xf4)) | (0x1 << 15);
    *((V_UINT32P)(DDRPHY_BASE + 0xf4)) = *((V_UINT32P)(DDRPHY_BASE + 0xf4)) | (0x1 << 15);
#endif
